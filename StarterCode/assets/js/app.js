...
d3.csv("assets/data/data.csv").then(function(csvData, err) {
    ...
    console.log(error);
        ...
        // adding the max scale for the y axis here
        // var yHealthcareScale = d3.scaleLinear()
        //     .domain([0,d3.max(povertyData,d=>d.healthcare)])
        //     .range([chartHeight,0]);


        // var povertyMax = d3.max(povertyData, d=>d.poverty);

        // var yMax = d3.max(povertyMax);
        // console.log(yMax);

        // yHealthcareScale.domain([0, yMax]);

        // creating the x axis here
        ...
        //     .attr("y", d => (yHealthcareScale(d.healthcare-0.28)))
        ...
        // adding athestics below (tooltips and text)
        // dont know of the "tooltip" should be ".d3-tip" because of css file

        // circlesGroup
        //     .on("mousover",function(d) {toolTip.html(`<strong>${povertyData[abbr]}</strong>`)})
        ...
        //         toolTip.hide(d);
        //     });
            // im getting an error when adding this on
